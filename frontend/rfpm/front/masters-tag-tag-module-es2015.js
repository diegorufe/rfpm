...
/* harmony import */ var src_app_services_masters_tag_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/masters/tag.service */ "./src/app/services/masters/tag.service.ts");
...
function TagComponent_ng_container_1_ng_template_2_ng_template_1_Template(rf, ctx) { if (rf & 1) {
...
function TagComponent_ng_container_1_ng_template_2_ng_template_3_ng_template_3_Template(rf, ctx) { if (rf & 1) {
...
function TagComponent_ng_container_1_ng_template_2_ng_template_3_Template(rf, ctx) { if (rf & 1) {
...
function TagComponent_ng_container_1_ng_template_2_Template(rf, ctx) { if (rf & 1) {
...
function TagComponent_ng_container_1_Template(rf, ctx) { if (rf & 1) {
...
function TagComponent_ng_container_2_form_1_ng_template_3_ng_template_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "rf-toolbarred", 15);
} if (rf & 2) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2);
    const _r54 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](1);
...
function TagComponent_ng_container_2_form_1_ng_template_3_ng_template_3_ng_template_3_Template(rf, ctx) { if (rf & 1) {
...
function TagComponent_ng_container_2_form_1_ng_template_3_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 8);
...
function TagComponent_ng_container_2_form_1_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "rf-toolbarpage");
...
function TagComponent_ng_container_2_form_1_Template(rf, ctx) { if (rf & 1) {
...
function TagComponent_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementContainerStart"](0);
...
class TagComponent extends rfnglib__WEBPACK_IMPORTED_MODULE_2__["BaseRedControllerComponent"] {
     ...
     */
    styleCard() {
        if (rfnglib__WEBPACK_IMPORTED_MODULE_2__["CommonsUtils"].isNotNull(this.element) && rfnglib__WEBPACK_IMPORTED_MODULE_2__["CommonsUtils"].isNotNull(this.element)
            && rfnglib__WEBPACK_IMPORTED_MODULE_2__["CommonsUtils"].isNotNull(this.element.color) && this.oldColor !== this.element.color) {
    ...
    styleRow(style, rowData) {
        if (rfnglib__WEBPACK_IMPORTED_MODULE_2__["CommonsUtils"].isNotNull(rowData)
            && rfnglib__WEBPACK_IMPORTED_MODULE_2__["CommonsUtils"].isNotNull(rowData.color)) {
            style['background-color'] = this.rfngService.convertHexColorToRgba(rowData.color, 0.5);
        }
        return style;
    }
}
TagComponent.ɵfac = function TagComponent_Factory(t) { return new (t || TagComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](rfnglib__WEBPACK_IMPORTED_MODULE_2__["RfngService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_services_masters_tag_service__WEBPACK_IMPORTED_MODULE_3__["TagService"])); };
TagComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: TagComponent, selectors: [["rfpm-tag"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵInheritDefinitionFeature"]], decls: 3, vars: 2, consts: [[3, "ngSwitch"], [4, "ngSwitchCase"], [4, "ngSwitchDefault"], [3, "idPage"], ["rfTemplate", "pageContent"], ["rfTemplate", "toolBarPageContent"], ["rfTemplate", "bodyPageContent"], [3, "baseController"], [1, "floatLeftFullDiv"], [3, "title"], ["rfTemplate", "cardContent"], [3, "columns", "baseControllerLazyLoad"], ["novalidate", "", "class", "floatLeftFullDiv", 4, "ngIf"], ["novalidate", "", 1, "floatLeftFullDiv"], ["frm", "ngForm"], [3, "baseController", "form"], [3, "title", "styleBody"], [1, "floatLeftFullDivCard"], [3, "name", "disabled", "required", "model", "property", "max", "label"], [3, "name", "disabled", "model", "property", "label"]], template: function TagComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _tag_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./tag.component */ "./src/app/components/masters/tag/tag.component.ts");
...
class TagModule extends rfnglib__WEBPACK_IMPORTED_MODULE_0__["BaseModule"] {
}
TagModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({ type: TagModule, bootstrap: [_tag_component__WEBPACK_IMPORTED_MODULE_4__["TagComponent"]] });
TagModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({ factory: function TagModule_Factory(t) { return ɵTagModule_BaseFactory(t || TagModule); }, providers: [src_app_services_masters_tag_service__WEBPACK_IMPORTED_MODULE_5__["TagService"]], imports: [[
            ...
            rfnglib__WEBPACK_IMPORTED_MODULE_0__["InputColorModule"]
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](TagModule, { declarations: [_tag_component__WEBPACK_IMPORTED_MODULE_4__["TagComponent"]], imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"],
        _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        rfnglib__WEBPACK_IMPORTED_MODULE_0__["ButtonModule"],
        rfnglib__WEBPACK_IMPORTED_MODULE_0__["CardModule"],
        ...
        rfnglib__WEBPACK_IMPORTED_MODULE_0__["I18nModule"],
        rfnglib__WEBPACK_IMPORTED_MODULE_0__["InputTextModule"],
        rfnglib__WEBPACK_IMPORTED_MODULE_0__["InputColorModule"]], exports: [_tag_component__WEBPACK_IMPORTED_MODULE_4__["TagComponent"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](TagModule, [{
        ...
        args: [{
                ...
                exports: [
                    _tag_component__WEBPACK_IMPORTED_MODULE_4__["TagComponent"],
                ],
...
const ɵTagModule_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵgetInheritedFactory"](TagModule);


/***/ })

}]);
//# sourceMappingURL=masters-tag-tag-module-es2015.js.map