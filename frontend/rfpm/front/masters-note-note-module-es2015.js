...
/* harmony import */ var src_app_services_masters_note_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/masters/note.service */ "./src/app/services/masters/note.service.ts");
...
function NoteComponent_ng_container_1_ng_template_4_ng_template_1_Template(rf, ctx) { if (rf & 1) {
...
function NoteComponent_ng_container_1_ng_template_4_ng_template_3_ng_template_3_Template(rf, ctx) { if (rf & 1) {
...
function NoteComponent_ng_container_1_ng_template_4_ng_template_3_ng_template_6_ng_template_1_Template(rf, ctx) { if (rf & 1) {
...
function NoteComponent_ng_container_1_ng_template_4_ng_template_3_ng_template_6_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r66 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](4);
...
function NoteComponent_ng_container_1_ng_template_4_ng_template_3_Template(rf, ctx) { if (rf & 1) {
...
function NoteComponent_ng_container_1_ng_template_4_Template(rf, ctx) { if (rf & 1) {
...
function NoteComponent_ng_container_1_Template(rf, ctx) { if (rf & 1) {
...
function NoteComponent_ng_container_2_form_1_ng_template_3_ng_template_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "rf-toolbarred", 20);
} if (rf & 2) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2);
    const _r70 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](1);
...
function NoteComponent_ng_container_2_form_1_ng_template_3_ng_template_3_ng_template_3_Template(rf, ctx) { if (rf & 1) {
...
function NoteComponent_ng_container_2_form_1_ng_template_3_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 10);
...
function NoteComponent_ng_container_2_form_1_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "rf-toolbarpage");
...
function NoteComponent_ng_container_2_form_1_Template(rf, ctx) { if (rf & 1) {
...
function NoteComponent_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementContainerStart"](0);
...
class NoteComponent extends rfnglib__WEBPACK_IMPORTED_MODULE_2__["BaseRedControllerComponent"] {
    ...
    setFiltersBrowser() {
        ...
        this.filtersBrowser.push(new rfnglib__WEBPACK_IMPORTED_MODULE_2__["Filter"]('tagId', null, { id: null, code: null, description: null }, "and", null, "id"));
     ...
     */
    styleCard() {
        if (rfnglib__WEBPACK_IMPORTED_MODULE_2__["CommonsUtils"].isNotNull(this.element) && rfnglib__WEBPACK_IMPORTED_MODULE_2__["CommonsUtils"].isNotNull(this.element.Tag)
            && rfnglib__WEBPACK_IMPORTED_MODULE_2__["CommonsUtils"].isNotNull(this.element.Tag.color) && this.oldColor !== this.element.Tag.color) {
    ...
    styleRow(style, rowData) {
        if (rfnglib__WEBPACK_IMPORTED_MODULE_2__["CommonsUtils"].isNotNull(rowData) && rfnglib__WEBPACK_IMPORTED_MODULE_2__["CommonsUtils"].isNotNull(rowData.Tag)
            && rfnglib__WEBPACK_IMPORTED_MODULE_2__["CommonsUtils"].isNotNull(rowData.Tag.color)) {
...
NoteComponent.ɵfac = function NoteComponent_Factory(t) { return new (t || NoteComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](rfnglib__WEBPACK_IMPORTED_MODULE_2__["RfngService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_services_masters_note_service__WEBPACK_IMPORTED_MODULE_3__["NoteService"])); };
NoteComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: NoteComponent, selectors: [["rfpm-note"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵInheritDefinitionFeature"]], decls: 3, vars: 2, consts: [[3, "ngSwitch"], [4, "ngSwitchCase"], [4, "ngSwitchDefault"], ["novalidate", "", 1, "floatLeftFullDiv"], ["frm", "ngForm"], [3, "idPage"], ["rfTemplate", "pageContent"], ["rfTemplate", "toolBarPageContent"], ["rfTemplate", "bodyPageContent"], [3, "baseController", "renderTableViews"], [1, "floatLeftFullDiv"], [3, "title"], ["rfTemplate", "cardContent"], [3, "disabled", "required", "model", "model2", "property", "max", "label", "disabledButton", "componentView", "serviceName", "moduleView", "titleSelect", "name", "property2", "max2"], [3, "name", "disabled", "required", "model", "property", "max", "label"], [3, "columns", "baseControllerLazyLoad", "typeView"], ["rfTemplate", "tableGridLine"], [1, "NoteGridLine"], [1, "NoteGridLineContent"], ["novalidate", "", "class", "floatLeftFullDiv", 4, "ngIf"], [3, "baseController", "form"], [3, "title", "styleBody"], [1, "floatLeftFullDivCard"], [2, "float", "left", "clear", "left"], [3, "name", "disabled", "required", "model", "property", "cols", "rows", "label"]], template: function NoteComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _note_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./note.component */ "./src/app/components/masters/note/note.component.ts");
/* harmony import */ var src_app_services_masters_note_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/masters/note.service */ "./src/app/services/masters/note.service.ts");
/* harmony import */ var src_app_services_masters_proyect_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/masters/proyect.service */ "./src/app/services/masters/proyect.service.ts");
/* harmony import */ var src_app_services_masters_tag_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/services/masters/tag.service */ "./src/app/services/masters/tag.service.ts");
...
class NoteModule extends rfnglib__WEBPACK_IMPORTED_MODULE_0__["BaseModule"] {
}
NoteModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({ type: NoteModule, bootstrap: [_note_component__WEBPACK_IMPORTED_MODULE_4__["NoteComponent"]] });
NoteModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({ factory: function NoteModule_Factory(t) { return ɵNoteModule_BaseFactory(t || NoteModule); }, providers: [src_app_services_masters_note_service__WEBPACK_IMPORTED_MODULE_5__["NoteService"], src_app_services_masters_proyect_service__WEBPACK_IMPORTED_MODULE_6__["ProyectService"], src_app_services_masters_tag_service__WEBPACK_IMPORTED_MODULE_7__["TagService"]], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](NoteModule, { declarations: [_note_component__WEBPACK_IMPORTED_MODULE_4__["NoteComponent"]], imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"],
        _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        rfnglib__WEBPACK_IMPORTED_MODULE_0__["ButtonModule"],
        rfnglib__WEBPACK_IMPORTED_MODULE_0__["CardModule"],
        ...
        rfnglib__WEBPACK_IMPORTED_MODULE_0__["InputTextModule"],
        rfnglib__WEBPACK_IMPORTED_MODULE_0__["InputTextAreaModule"],
        rfnglib__WEBPACK_IMPORTED_MODULE_0__["InputButtonModule"]], exports: [_note_component__WEBPACK_IMPORTED_MODULE_4__["NoteComponent"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](NoteModule, [{
        ...
        args: [{
                ...
                exports: [
                    _note_component__WEBPACK_IMPORTED_MODULE_4__["NoteComponent"],
                ],
...
const ɵNoteModule_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵgetInheritedFactory"](NoteModule);
 ...
 */
class NoteService extends rfnglib__WEBPACK_IMPORTED_MODULE_0__["BaseService"] {
    constructor(rfngService, httpClient) {
        super(rfngService, httpClient, '/secure/note');
    }
}
NoteService.ɵfac = function NoteService_Factory(t) { return new (t || NoteService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](rfnglib__WEBPACK_IMPORTED_MODULE_0__["RfngService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"])); };
NoteService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({ token: NoteService, factory: NoteService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](NoteService, [{
...
//# sourceMappingURL=masters-note-note-module-es2015.js.map